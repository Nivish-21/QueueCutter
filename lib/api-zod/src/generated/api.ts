...
export const GetFormResponse = zod.object({
  ...
  "type": zod.enum(['text', 'date', 'select', 'radio', 'number', 'textarea', 'yesno']),
  "options": zod.array(zod.string()).optional(),
  "required": zod.boolean(),
  "fieldMapping": zod.string(),
  "validationPattern": zod.string().optional(),
  "conditionalOn": zod.object({
...
export const GetPreviewResponse = zod.object({
  ...
  "formName": zod.string(),
  "mappedFields": zod.array(zod.object({
...
export const GetWarningsResponse = zod.object({
  ...
  "category": zod.enum(['missing', 'format', 'inconsistency', 'eligibility', 'general']),
...
export const GetChecklistResponse = zod.object({
  ...
  "submissionSteps": zod.array(zod.object({
  "step": zod.number(),
  "title": zod.string(),
