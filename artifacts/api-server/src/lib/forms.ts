...
export const FORMS: FormSchema[] = [
  // ─────────── UNITED STATES ───────────
  {
    ...
    questions: [
      ...
      { id: "has_expense_deductions", text: "Do you pay for childcare, medical expenses (if aged 60+ or disabled), or other dependent care costs?", hint: "These costs can be deducted from your countable income, potentially increasing your SNAP benefit amount. Gather receipts — your caseworker will apply deductions during your interview.", type: "yesno", required: false, fieldMapping: "has_expense_deductions", officialLabel: "Expense Deductions (Childcare / Medical / Dependent Care)" },
  ...
  // ─────────── UNITED KINGDOM ───────────
  {
    ...
    questions: [
      ...
      { id: "date_of_birth", text: "What is your date of birth?", type: "date", required: true, fieldMapping: "date_of_birth", officialLabel: "Date of Birth" },
      { id: "pension_age", text: "Are you or your partner aged 66 or over, or receiving State Pension or Pension Credit?", hint: "Pension-age applicants are assessed under the national protected CTR scheme — more generous rules than the local authority working-age scheme. Working-age rules vary by council.", type: "yesno", required: true, fieldMapping: "pension_age_applicant", officialLabel: "Pension Age / Working Age Status" },
